...
//  VPolor
//
//  Created by Vinson.D.Warm on 12/30/13, Modify by Chi-Tung Tsai on 07/07/2014
//  Copyright (c) 2013 Huang Vinson. All rights reserved.
//
//
// Copyright 2013 Huang Vinson
//
...
- (void)initView {
    self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"MatchColor.jpg"]];;
    ...
    self.overlayView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"MatchColor.jpg"]];
...
- (void)initControlBtn {
    ...
    cancelBtn.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"MatchColor.jpg"]];
    cancelBtn.titleLabel.textColor = [UIColor whiteColor];
    [cancelBtn setTitle:@"Cancel" forState:UIControlStateNormal];
    [cancelBtn.titleLabel setFont:[UIFont fontWithName:@"Futura" size:18]];
    ...
    confirmBtn.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"MatchColor.jpg"]];
    confirmBtn.titleLabel.textColor = [UIColor whiteColor];
    [confirmBtn setTitle:@"OK" forState:UIControlStateNormal];
    [confirmBtn.titleLabel setFont:[UIFont fontWithName:@"Futura" size:18]];
